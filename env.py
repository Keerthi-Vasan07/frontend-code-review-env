...
class FrontendCodeReviewEnv:
    ...
    def step(
        ...
        grade_result: GradeResult = grade(action.code, self._current_task)
        self._last_reward = grade_result.total_reward
        ...
        info: Dict[str, Any] = {
            ...
            "style_score": grade_result.style_score,
            "responsiveness_score": grade_result.responsiveness_score,
            "accessibility_score": grade_result.accessibility_score,
            "code_quality_score": grade_result.code_quality_score,
            "penalties": grade_result.penalties,
            "total_reward": grade_result.total_reward,
            "task_id": self._current_task.task_id,
            "difficulty": self._current_task.difficulty.value,
        }

        return observation, grade_result.total_reward, True, info
